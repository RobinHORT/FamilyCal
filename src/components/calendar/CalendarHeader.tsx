    ...
    <div id="calendar-header-section" className="flex flex-col gap-2 pb-2 border-b border-gray-200 shrink-0">
      ...
      <div className="hidden md:flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          <div id="calendar-view-mode-tabs" className="flex items-center bg-blue-50/80 p-0.5 rounded-xl border border-blue-200/60 shadow-2xs">
      ...
      <div id="calendar-layer-filter-bar" className="flex items-center gap-1.5 sm:gap-2 overflow-x-auto pb-0.5 scrollbar-none text-xs">
